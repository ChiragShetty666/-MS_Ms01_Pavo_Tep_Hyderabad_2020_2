...
function Faker(opts) {
    ...
    self.hobbies = new Hobbies(self);
    var Football = require("./Football");
    self.Football= new Football(self);
    ...
    var _definitions = {
        ...
        hobbies: ["outdoorActivities", "indoorActivities"],
        ...
        title: "",
        separator: "",
        laptop: ["name", "processor", "price"],
        Football: ["clubs", "Nationalteam", "sponsers", "CupChampions"],
    };
